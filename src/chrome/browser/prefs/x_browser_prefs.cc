...
void RegisterProfilePrefsX(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterBooleanPref(
      ...
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXShowBookmarksButton,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXOpenBookmarksInNewTab,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXOpenAddressInNewTab,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseTabWhenRightClick,
      false,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseTabWhenRLDoubleClick,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXNewTabForeground,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);

  //设置退出浏览器清理数据的能力
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearDataEnable,
      false,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearBrowserHistory,
      true,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearDownloadHistory,
      true,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearCache,
      false,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearCookie,
      false,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearPassword,
      true,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearAutoFill,
      false,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXCloseBrowserClearIEContents,
      true,
      user_prefs::PrefRegistrySyncable::UNSYNCABLE_PREF);

  //鼠标控制配置
  registry->RegisterBooleanPref(
      prefs::kXMouseGestureEnabled,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXSuperDragDropEnabled,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
  registry->RegisterBooleanPref(
      prefs::kXSuperDragDropOpenBackend,
      true,
      user_prefs::PrefRegistrySyncable::SYNCABLE_PREF);
